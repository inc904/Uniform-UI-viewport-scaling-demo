...
@use '../../styles/fn.module.scss' as fn;

.column {
    width: calc(25% - #{fn.scaleValue(40)});
}

.feedItem {
    position: relative;
    margin-bottom: #{fn.scaleValue(50)};
    border-radius: #{fn.scaleValue(10)};
    overflow: hidden;
    background: white;
}

.feedDesc {
    // margin: #{fn.scaleValue(32)} 0 0 0;
    font-size: #{fn.scaleValue(16)};
}

.feedTags {
    margin-bottom: #{fn.scaleValue(var(--ref-margin-bottom))};
}

.feedTag {
    display: inline-block;
    margin-right: #{fn.scaleValue(6)};
    margin-bottom: #{fn.scaleValue(6)};
    padding: #{fn.scaleValue(5)} #{fn.scaleValue(10)};
    border-radius: #{fn.scaleValue(4)};
    font-size: #{fn.scaleValue(15)};
    color: #111;
...
.feedTitle {
    font-size: #{fn.scaleValue(40)};
}

.feedItemLink {}

.feedButton {
    margin-top: #{fn.scaleValue(32)};
    font-size: #{fn.scaleValue(20)};
    color: #4339F2;
    background: none;
    border: none;
}
...
.feedWrapper {
    padding: #{fn.scaleValue(16)} #{fn.scaleValue(20)};
    position: relative;
    z-index: 2;
